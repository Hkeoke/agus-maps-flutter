...
class AgusMapsFlutterBindings {
  ...
  void comaps_set_map_style(
    int style,
  ) {
    return _comaps_set_map_style(
      style,
    );
  }

  late final _comaps_set_map_stylePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int)>>(
          'comaps_set_map_style');
  late final _comaps_set_map_style =
      _comaps_set_map_stylePtr.asFunction<void Function(int)>();

  /// Get the current map style
  int comaps_get_map_style() {
    return _comaps_get_map_style();
  }

  late final _comaps_get_map_stylePtr =
      _lookup<ffi.NativeFunction<ffi.Int Function()>>('comaps_get_map_style');
  late final _comaps_get_map_style =
      _comaps_get_map_stylePtr.asFunction<int Function()>();
